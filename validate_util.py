...
def validate_share_mochang(model, annotation_loader, device,writer_epoch):
    num_true_pos = 0.
    num_predicted_pos = 0.
    num_real_pos = 0.
    num_words = 0
    ...
    writer.add_scalar('test_acc', accuracy, epoch)
    print(
        "annotation dataset : recall:{:.4f} precision:{:.4f} f1-score:{:.4f} accuracy:{:.4f} mochang:{:.2f}".format(recall, precision,
                                                                                                     f1_score,
                                                                                                     accuracy,avg_mochang))
